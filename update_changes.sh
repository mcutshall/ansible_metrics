...
wget -P /opt/dev/atmosphere-ansible/ansible/playbooks/instance_deploy/callback_plugins/ https://raw.githubusercontent.com/mcutshall/ansible_metrics/master/profile_tasks.py
...
wget -P /opt/env/atmo_master/lib/python2.7/site-packages/subspace/plugins/callback/ https://raw.githubusercontent.com/mcutshall/ansible_metrics/master/profile_tasks.py
python -m py_compile profile_tasks.py
